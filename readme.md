# [vivekbiju](https://github.com/vivekbiju) | [README.md](https://github.com/vivekbiju/vivekbiju/blob/main/README.md)
...
<!--
    High-Level Core Stack Badges (matching style of Primary Badges)
-->
...
<!--
     broader Tools/Skills Cloud Matrix (matching color-coded chips style)
-->
**AI Engineering, MLOps, & Infrastructure**
<br>
![XGBoost](https://img.shields.io/badge/XGBoost-111111?style=for-the-badge)
![LangGraph](https://img.shields.io/badge/LangGraph-1C3C3A?style=for-the-badge&logo=opsgenie&logoColor=white)
![ChromaDB](https://img.shields.io/badge/ChromaDB-042858?style=for-the-badge&logo=chroma&logoColor=white)
![RAGAS](https://img.shields.io/badge/RAGAS-FC6058?style=for-the-badge&logo=google&logoColor=white)
![LangSmith](https://img.shields.io/badge/LangSmith-0052CC?style=for-the-badge&logo=langsmith&logoColor=white)
![MLflow](https://img.shields.io/badge/MLflow-0194E2?style=for-the-badge&logo=mlflow&logoColor=white)
![NSGA-II](https://img.shields.io/badge/NSGA--II-121212?style=for-the-badge)
![Soft Actor-Critic (SAC)](https://img.shields.io/badge/SAC-3670A0?style=for-the-badge)
![Grad-CAM](https://img.shields.io/badge/Grad--CAM-EE4C2C.svg?style=for-the-badge)
...
<!-- 
    Flagship Projects: Use side-by-side or stacked structured HTML cards with clean headers and direct 'VIEW PROJECT' buttons.
-->

<div align="center" style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap; margin-bottom: 30px;">

  <!-- CARD 1: AgenticOps -->
  <div style="flex: 1 1 45%; min-width: 320px; border: 1px solid #ddd; border-radius: 8px; padding: 15px; text-align: left;">
    <h3 align="center" style="color: #0077B5; margin-top: 0;">🚀 AgenticOps</h3>
    <p align="center">
  ...
  <!-- CARD 2: Advanced RAG -->
  <div style="flex: 1 1 45%; min-width: 320px; border: 1px solid #ddd; border-radius: 8px; padding: 15px; text-align: left;">
    <h3 align="center" style="color: #0077B5; margin-top: 0;">🩺 Advanced RAG Research Assistant</h3>
    <p align="center">
...
<!-- Second Row of Featured AI -->
<div align="center" style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap; margin-bottom: 30px;">

  <!-- CARD 3: Slang Sentiment -->
  <div style="flex: 1 1 45%; min-width: 320px; border: 1px solid #ddd; border-radius: 8px; padding: 15px; text-align: left;">
    <h3 align="center" style="color: #0077B5; margin-top: 0;">🚀 Slang-Aware Sentiment Engine</h3>
    <p align="center">
  ...
  <!-- CARD 4: Skin Cancer MSc -->
  <div style="flex: 1 1 45%; min-width: 320px; border: 1px solid #ddd; border-radius: 8px; padding: 15px; text-align: left; background-color: #f9f9f9;">
    <h3 align="center" style="color: #0077B5; margin-top: 0;">🩺 Hybrid Skin Cancer Diagnostic System</h3>
    <p align="center">
